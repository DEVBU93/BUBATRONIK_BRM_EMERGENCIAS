...
export default async function handler(req,res){
 const feeds=[{name:'METEOALARM-ES',url:'https://feeds.meteoalarm.org/feeds/meteoalarm-legacy-atom-spain'}];
 const aemetIndex='https://www.aemet.es/es/rss_info/avisos/esp';
